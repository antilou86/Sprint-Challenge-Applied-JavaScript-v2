...
1. What is the DOM?
    Document Object Model. it is essentially the browsers interpretation of a website's (or app's) given code.

2. What is an event?
    An event is a user interaction with the webpage (ie- scroll, click, zoom, etc)

3. What is an event listener?
    an event listener is basically a function waiting for a specific user interaction to trigger.

4. Why would we convert a NodeList into an Array?
    a NodeList is a array-like-object and does not have as many methods available for manipulation.
